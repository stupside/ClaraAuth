...
namespace Bytes
{
	...
	inline string toHexString(const ByteString& bstr)
	{
		std::string ret;
	...
	inline ByteString u32beToByteString(uint32_t num)
	{
	...
	inline ByteString u64beToByteString(uint64_t num)
	{
	...
	static string bytesToB32Chunk(const ByteString& bs)
	{
	...
	inline string toBase32(const ByteString& bs)
	{
		std::string ret;
